...
export default function AboutPage() {
  return (
    <>
    <div className="min-h-screen flex flex-col pt-22 px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12">
      <Header />
      <div className="flex flex-col md:flex-row flex-1">
        {/* Left: Image Section */}
        <div className="w-full md:w-1/2 h-64 md:h-auto">
          <div className="relative w-full h-full aspect-[4/3] md:aspect-auto bg-[#f0e9e0] flex items-center justify-center border border-dashed border-[#74512D] rounded-4xl overflow-hidden">
            <Image
              src="/img1.jpg"
              alt="me"
              fill
        ...
        {/* Right: Text Section */}
        <div className="w-full md:w-1/2 md:pl-8 lg:pl-16 py-16 flex flex-col justify-center">
