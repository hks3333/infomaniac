  ...
  return (
    ...
    <header className="h-16 bg-background w-full flex justify-between items-center px-2 sm:px-4 md:px-6 lg:px-8 xl:px-12 border-b border-dashed border-[#74512D] fixed top-0 left-0 z-50">
      ...
      <div className="hidden md:flex items-center space-x-6">
        <button onClick={() => router.push('/categories')} className="text-sm font-open font-semibold cursor-pointer text-red-600 hover:text-red-800 transition-colors duration-300">
          Categories
        </button>
